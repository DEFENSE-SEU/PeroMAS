...
# Input
raw_file_name = "data/raw/mattergen.csv"
run_mode = "Interpret" # "Hyperopt", "Train", "Predict", "Interpret"
calc_shap = True

target = [
    "pce", "dft_band_gap", "energy_above_hull", 
    "stability_retention", "stability_t80", 
    "voc", "jsc", "ff" 
]
