...
TEST_QUERIES = [
    # === Group 1: Phase Stability & Composition (Q001-Q003) ===
    {
        "id": "Q021",
        "type": "wet-experiment",
        "query":"""I am currently working with a perovskite fabrication protocol based on "Candidate Material 3: Multi-cation Entropy-Stabilized Perovskite." The chemical composition is defined as $Cs_{0.05}(FA_{0.85}MA_{0.15})_{0.95}Pb(I_{0.85}Br_{0.15})_3$ with the addition of 1 mol% Ethylenediamine (EDA).Theoretical Mechanism: The design utilizes the $Cs^+/FA^+/MA^+$ triple-cation mix to increase configurational entropy and stabilize the cubic $\alpha$-phase. Bandgap engineering via the $I_{0.85}Br_{0.15}$ ratio targets an optimal single-junction value of 1.60–1.63 eV. EDA serves two roles: defect passivation by forming ethylenediammonium cations with under-coordinated $Pb^{2+}$ at grain boundaries, and suppression of $I^-/Br^-$ phase segregation through grain boundary cross-linking.Current Experimental Setup:BOM (for 10 mL precursor): 5693.4 mg $PbI_2$, 1900.6 mg FAI, 308.1 mg MAI, 168.9 mg CsI, 218.4 mg MABr, and 7.8 mg EDA.Solvents: 8.0 mL DMF / 2.0 mL DMSO (4:1 ratio); Chlorobenzene (CB) as the antisolvent.Process: 1.3 M concentration; Two-step spin-coating (1000 rpm/10s; 4000 rpm/30s); Antisolvent dripping at the 20s mark; Annealing at 100°C for 60 minutes in ambient air (RH <40%).The Issue:While literature suggests this EDA-enhanced formula can reach 19–21% PCE, my experimental results yielded only 5% PCE. Professional feedback indicates that the current precursor concentration might be too low and suggests the incorporation of $PbBr_2$ into the formulation.Request:Please analyze the potential reasons why the current protocol resulted in only a 5% PCE.Based on the professional feedback regarding concentration and $PbBr_2$ addition, please optimize the experimental protocol and provide the revised formulation.
       """ 
    }
]
